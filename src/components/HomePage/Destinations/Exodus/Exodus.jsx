                    ...
                    <div className="destination-info">
                        ...
                        <div className="destination-promo-wrapper">
                            <div className="destination-promo">
                                <video className="two-promo-vid" id="destination-promo-video-exodus-2" src="./media/exodus/under-water-r.mov" autoplay loop muted></video>
                            ...
                            <div className="destination-promo">
                                ...
                                <video class="two-promo-vid" id="destination-promo-video-exodus-3" src="/media/exodus/underwater.mov" autoplay loop muted></video>
                            </div>
                            <div className="destination-promo">
                                <video className="two-promo-vid" id="destination-promo-video-exodus-1" src="/media/exodus/under-water.mov" autoplay loop muted></video>
                            ...
                            <div className="destination-promo">
                                <video className="two-promo-vid" id="destination-promo-video-exodus-4" src="./media/exodus/whales.mov" autoplay loop muted></video>
