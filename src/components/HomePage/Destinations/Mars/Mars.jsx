                ...
                <div className="destination-segment destination-mars">
                    <div className="destination-info">
                        ...
                        <div className='mars-text'>
                            ...
                            <p className="destination-mars-p">Enjoy guided tours of past rover and landing sites, a Martian sunset, and the unique geological formations that make this planet so mysterious and captivating.<br/>
                    ...
                    <p className="destination-mars-p">Let us make your dream of visiting Mars a reality!</p>
                </div>
            </div>
    )
}